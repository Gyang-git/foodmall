<template>
  <el-dialog
    ...
    <el-form-item label="上下线状态" prop="upStatus">
      <el-input v-model="dataForm.upStatus" placeholder="上下线状态"></el-input>
    </el-form-item>
    <el-form-item label="创建时间" prop="createTime">
      <el-input v-model="dataForm.createTime" placeholder="创建时间"></el-input>
    </el-form-item>
    <el-form-item label="创建人" prop="status">
      <el-input v-model="dataForm.status" placeholder="创建人"></el-input>
    </el-form-item>
    </el-form>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.upStatus = data.seckillPromotion.upStatus
          ...
          if (valid) {
            this.$http({
              ...
              data: this.$http.adornData({
                ...
                'upStatus': this.dataForm.upStatus,
